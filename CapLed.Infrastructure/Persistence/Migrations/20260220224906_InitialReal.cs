        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinThreshold = table.Column<int>(type: "int", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactRequests_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockMovements_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipments_Reference",
                table: "Equipments",
                column: "Reference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Photos_EquipmentId",
                table: "Photos",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_EquipmentId",
